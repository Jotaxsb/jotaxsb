...
if (!global.support.ffmpegWebp) conn.logger.warn('Stickers Jota not animated without libwebp on ffmpeg (--emable-ibwebp while compiling ffmpeg)')
if (!global.support.convert) conn.logger.warn('Stickers Jota not work without imagemagick if libwebp on ffmpeg doesnt isntalled (pkg install imagemagick)')
